...
class tripController {
  ...
  static async getTrip(req, res) {
    ...
    if (findTrip) {
      res.status(200).json({ message: res.__('Trip retrieved succesfully'), Trip: findTrip });
    }
    if (!findTrip) {
      return res
        .status(404)
  ...
  static async getTrips(req, res) {
    ...
    if (findTrips) {
      res.status(200).json({ message: res.__('Trips retrieved succesfully'), Trips: findTrips });
    }
  }
  ...
  static async updateTrip(req, res) {
    ...
    if (findTrip) {
      ...
      res
        .status(201)
        .json({ msg: res.__('Trip updated succesfuly'), Trip: updatedTrip });
    }
  }
  ...
  static async deleteTrip(req, res) {
    ...
    if (findTrip) {
      ...
      res
        .status(201)
        .json({ msg: res.__('Trip deleted succesfuly'), Trip: deleteTrip });
    }
  }
}
